// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["youzhi", "ruyi", "baofeng", "tianya", "feifan"]'); // 默认选中资源
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["youzhi", "ruyi", "baofeng", "tianya", "feifan"];
...
function resetSearchArea() {
    ...
    try {
        ...
        // 更新页面标题
        document.title = `发现TV - 免费在线影视搜索与观看平台`;
    } catch (e) {
